      ...
      <div class="form-container">
        <form action="process_form.php" method="post">
          <div class="form-group">
                ...
                <button type="button" class="course-buttons" data-role="UCZEŃ">Uczeń</button>
                <button type="button" class="course-buttons" data-role="KOREPETYTOR">Korepetytor</button>
            ...
            <input type="email" id="email" name="email" placeholder="JanKowalski@example.com" required><br></br>
